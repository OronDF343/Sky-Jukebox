...
namespace FlacBox
{
    ...
    public sealed class FlacEncodingPolicy
    {
        ...
        {
            FixedOrder = cloneFrom.FixedOrder;
            LpcOrder = cloneFrom.LpcOrder;
            RicePartionOrder = cloneFrom.RicePartionOrder;
            StereoEncoding = cloneFrom.StereoEncoding;
            UseParallelExtensions = cloneFrom.UseParallelExtensions;
        }
