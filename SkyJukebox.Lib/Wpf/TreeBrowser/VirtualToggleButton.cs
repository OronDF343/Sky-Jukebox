...
namespace SkyJukebox.Lib.Wpf.TreeBrowser
{
    public static class VirtualToggleButton
    {
        ...
        internal static RoutedEventArgs RaiseCheckedEvent(UIElement target)
        {
            ...
            var args = new RoutedEventArgs(ToggleButton.CheckedEvent);
        ...
        internal static RoutedEventArgs RaiseUncheckedEvent(UIElement target)
        {
            ...
            var args = new RoutedEventArgs(ToggleButton.UncheckedEvent);
            RaiseEvent(target, args);
            return args;
        }
        ...
        internal static RoutedEventArgs RaiseIndeterminateEvent(UIElement target)
        {
            ...
            var args = new RoutedEventArgs(ToggleButton.IndeterminateEvent);
            RaiseEvent(target, args);
            return args;
        }
        ...
        private static void OnKeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Enter && (bool)(s).GetValue(KeyboardNavigation.AcceptsReturnProperty))
            {
                UpdateIsChecked(sender as DependencyObject);
                e.Handled = true;
            }
